...
class newCountryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val recyclerView = view.findViewById<RecyclerView>(R.id.recyclerOurNews)

        recyclerView.layoutManager = LinearLayoutManager(context)

        val newsList = NewsData().loadOurNews()
        ...
        adapter.setOnNewsClickListener(object : ourNewsRecycler.onNewsClickListenter {
            override fun onNewsClick(position: Int) {
                ...
                val action = newCountryFragmentDirections.actionNewCountryFragmentToNewsPageFragment(
                    title, desc)
